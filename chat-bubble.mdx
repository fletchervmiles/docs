...
| Wrong modal opens, or all bubbles open same modal | Multiple Franko snippets loaded on same page | Use only one Franko snippet per page. For multiple modals, see [patterns in Custom Triggers →](./custom-trigger#multiple-modals) |
