...
> **⚠️ IMPORTANT: Script Order Matters**<br/>
>
> The `window.FrankoUser` identity snippet must be executed **before** the main Franko embed script loads, otherwise user data will be missed.<br/>
>
